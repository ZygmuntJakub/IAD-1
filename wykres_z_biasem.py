...
#plt.text(3000, 0.372957, "0.372957", fontdict=None, withdash=False)
#plt.text(3000, 0.018564, "0.018564", fontdict=None, withdash=False)
#plt.text(3000, -0.005000, "0.005031", fontdict=None, withdash=False)
plt.grid(True)
plt.legend()
plt.show()